...
CREATE
OR REPLACE FUNCTION update_block_count () RETURNS TRIGGER AS '
BEGIN
    UPDATE stats 
...
CREATE TRIGGER trigger_update_block_count AFTER INSERT ON block FOR EACH ROW EXECUTE FUNCTION update_block_count ();