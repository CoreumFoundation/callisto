...
replace (
	...
	// replace broken ibc-hooks module compatible with tx-chain v6
	// github.com/cosmos/ibc-apps/modules/ibc-hooks/v8 => github.com/tokenize-x/tx-chain/v6/modules/ibc-hooks/v8 v8.0.0-20250801064028-4db66ba3f6f8
	// tokenize-x verison of the juno module
	github.com/forbole/juno/v6 => github.com/tokenize-x/tx-juno/v6 v6.0.0-20251001165459-6c6142c7501d
	// replace broken goleveldb compatible with tx-chain v6
...
require (
	...
	github.com/tokenize-x/tx-chain/v6 v6.0.0-rc1.0.20251223140913-ae2b7a57eb7e
